...
public class ReentrantLockCustom implements LockCustom {
	...
	/* (non-Javadoc)
	 * @see com.gtm.thread.concurrency.lock.LockCustom#lock()
	...
	/* (non-Javadoc)
	 * @see com.gtm.thread.concurrency.lock.LockCustom#unlock()
	...
	/* (non-Javadoc)
	 * @see com.gtm.thread.concurrency.lock.LockCustom#tryLock()
